(* The prettiest benchmark I have :) *)
(* It has been slightly ammended (Output format has been changed to make it
* easier to scan for. *)
...
let
  ...
  val res = doit ibox
  val expected =
    ""
  val pass = res = expected
  val endTime = Timer.checkRealTimer(time)
  val result_ok = if pass then "pass" else "fail"
